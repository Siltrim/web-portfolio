...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Данил Воронцов</h1>

      <h3 className="home__subtitle">Frontend разработчик</h3>
      <p className="home__description">
        Я - фронтенд разработчик, специализирующийся на создании веб-приложений с использованием
        передовых практик и лучших стандартов в индустрии.
      </p>
